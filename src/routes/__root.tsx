  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "International Skill Zone — PTE & IELTS Coaching with Prof. Umar" },
      {
        ...
        content:
          "Expert PTE/IELTS coaching, spoken English, and interview preparation. 1,500+ students trained across 25+ countries.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Dancing+Script:wght@600;700&family=Inter:wght@400;500;600;700&family=Poppins:wght@500;600;700;800;900&display=swap",
      },
